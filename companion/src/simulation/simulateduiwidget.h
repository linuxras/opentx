...
class SimulatedUIWidgetI6X: public SimulatedUIWidget
{
  Q_OBJECT

  public:
    explicit SimulatedUIWidgetI6X(SimulatorInterface * simulator, QWidget * parent = nullptr);
    virtual ~SimulatedUIWidgetI6X();

  private:
    Ui::SimulatedUIWidgetI6X * ui;
};
